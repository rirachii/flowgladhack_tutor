                ...
                <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                    ...
                    <div className="p-8 bg-gray-50 rounded-2xl border border-gray-200">
                        ...
                        <ul className="space-y-4 mb-8 text-gray-600">
                            <li className="flex items-center gap-2">✓ 100 AI Tokens / month</li>
                    ...
                    <div className="p-8 bg-blue-50 rounded-2xl border border-blue-100 relative overflow-hidden">
                        ...
                        <div className="text-4xl font-bold text-gray-900 mb-6">$29<span className="text-lg text-gray-600 font-normal">/mo</span></div>
                        <ul className="space-y-4 mb-8 text-gray-600">
